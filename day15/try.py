...
with open("day15/input.txt", "r") as f:
    ...
    for line in f:
        ...
        distances[(res[1], res[0])] = (manhattan((res[1], res[0]), (res[3], res[2])), getDist(np.array((res[3], res[2])), np.array((res[1], res[0]))))
        ...
        if key2 != key1:
            ...
            for x in [mid_x_f, mid_x_c]:
                for y in [mid_y_f, mid_y_c]:
                    if manhattan([y, x], key1) > val1[0] and manhattan([y, x], key2) > val2[0]:
